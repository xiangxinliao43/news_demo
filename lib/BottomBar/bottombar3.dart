...
class _BottomBar3State extends State<BottomBar3>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          flag?Image.file( File(imagePath!)
            ,fit: BoxFit.cover,
            height: double.infinity,
            width: double.infinity,
          ):ColoredBox(color: Colors.blue[100]!),
          Padding(
            padding: EdgeInsets.fromLTRB(SU.w(10),SU.h(10),SU.w(10),SU.h(10)),
            child: ListView(
              children: [
                Center(
                  child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(flex: 6, child: button('阅读设定',Icons.settings,_alertDalog)),
                                Expanded(flex: 4,child: Container(),),
                                Expanded(flex: 6,child: button('个人资料',Icons.account_circle,_alertDalog),),
                                const Expanded(flex: 1,child: Center(),)
                              ],
                            ),
                      ...
                      Opacity(
                        ...
                        child: Card(
                          child: ExpansionTile(
                            title: ListTile(
                                leading: Padding(
                                  padding: EdgeInsets.fromLTRB(SU.w(5), SU.h(8), SU.w(5), SU.h(5)),
                                  child: Icon(Icons.local_offer,color: Colors.black,size: SU.sp(25),),
                                ),
                                title: const Text('个性化',style: TextStyle(fontSize: 20,fontFamily: 'ZhiMangXing'),),
                                subtitle: const Text('personality',style: TextStyle(fontSize: 10),),
                                onTap: (){_handleTap();},
                              ),
                            trailing: Icon(
                            ...
                            child: Column(
                              children: [
                                ListTile(
                                  ...
                                  title: const Center(child: Text('登录',style: TextStyle(fontSize: 20),)),
                                  subtitle: const Center(child: Text('loge in')),
                                )
                              ],
                            )
                        ),
